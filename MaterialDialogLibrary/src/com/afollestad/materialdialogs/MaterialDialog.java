...
//            this.regularFont = Typeface.createFromAsset(getContext().getAssets(), "Roboto-Regular.ttf");
//        this.mediumFont = builder.mediumFont;
//        if (this.mediumFont == null)
//            this.mediumFont = Typeface.createFromAsset(getContext().getAssets(), "Roboto-Medium.ttf");
