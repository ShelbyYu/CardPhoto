 ...
 */
public class PhotoCategoryActivity extends BaseActivity implements AbsListView.OnScrollListener{
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.activity_photocategory);
        initView();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==1 && resultCode==PhotoCategoryActivity.RESULT_OK){
            if (data!=null){
                setResult(PhotoCategoryActivity.RESULT_OK,data);
                finish();
            }
        }
    }
    ...
    private void queryData(final int page, final int actionType) {
        ...
        SingleHttClient.getInstance().post("http://zero.myname9.com/index.php/app/pic/getCategory", params, new TextHttpResponseHandler() {
            @Override
    ...
    private List<CardPhotoBean> parseJson(String response) throws JSONException {
        ...
        JSONArray jsonArray=jsonObject.getJSONArray("picCategory");
        ...
        for (int i=0;i<jsonArray.length();i++){
            ...
            cardPhotoBean.setDescribe(itemObject.getString("describe"));
            cardPhotoBean.setAutor(itemObject.getString("author"));
    ...
    private void initView(){
        swipeRefreshLayout=(SwipeRefreshLayout)findViewById(R.id.category_swipelayout);
        jazzyGridView=(JazzyGridView)findViewById(R.id.category_gridview);
    }
