...
/**
 * Created by Shey on 2015/7/2 21:37.
...
public class PhotoUtil {
     ...
     * @return
     */
    public static Bitmap compressBitmap(Bitmap image,float width,float height) {
    ...
    public static int getPhotoWidth(String photoUrl){
        int width=0;
     ...
     * @throws
     */
    public static void saveBitmap(String photoUrl,Bitmap bitmap, boolean isDelete) {
